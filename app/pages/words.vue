<template>
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div v-if="loading" class="text-center py-12">
      ...
      <p class="mt-2 text-tertiary">Loading words...</p>
    </div>

    <div v-else class="space-y-4">
      <div v-if="activeTab === 'favorites'">
        <div v-if="favoriteWords.length === 0" class="text-center py-12 bg-white rounded-xl border border-dashed border-tertiary/30">
          <p class="text-tertiary">You haven't added any words to favorites yet.</p>
      ...
      <div v-if="activeTab === 'blocked'">
        <div v-if="blockedWords.length === 0" class="text-center py-12 bg-white rounded-xl border border-dashed border-tertiary/30">
          <p class="text-tertiary">You haven't blocked any words yet.</p>
        </div>
        <div v-else class="grid gap-4">
          <WordResult 
